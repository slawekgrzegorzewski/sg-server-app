cd "D:\Development\Zrzut produkcji\database-backups\current"
D:
...
rem "C:\Program Files\PostgreSQL\14\bin\psql.exe" -h localhost -U postgres -w accountant < "D:\Development\Zrzut produkcji\database-backups\current\%LAST%"
...
"C:\Program Files\PostgreSQL\14\bin\psql.exe" -h 192.168.52.98 -U postgres -w accountant < "D:\Development\Zrzut produkcji\database-backups\current\%LAST%"