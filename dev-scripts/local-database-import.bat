cd "E:\Zrzut produkcji\database-backups\current"
E:
...
"C:\Program Files\PostgreSQL\13\bin\psql.exe" -h localhost -U postgres -w accountant < "E:\Zrzut produkcji\database-backups\current\%LAST%"