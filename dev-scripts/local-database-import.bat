cd "D:\Zrzut produkcji\database-backups\"
D:
...
"C:\Program Files\PostgreSQL\13\bin\psql.exe" -h localhost -U postgres -w accountant < "D:\Zrzut produkcji\database-backups\%LAST%"